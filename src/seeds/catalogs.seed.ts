...
async function seedDatabase() {
  try {
    ...
    await Fabricante.bulkCreate([
      // ── Equipos mineros / cilindros (del Excel 5. Cod Rep) ──
      { codigo: 'CAT',  nombre: 'Caterpillar',       pais: 'USA',     activo: true },
      { codigo: 'KOM',  nombre: 'Komatsu',           pais: 'Japan',   activo: true },
      { codigo: 'EPI',  nombre: 'Epiroc',            pais: 'Sweden',  activo: true },
      // ── Proveedores materiales (del Excel 1 Log - material) ──
      { codigo: 'ALT',  nombre: 'Alternativo',       pais: 'Peru',    activo: true },
      { codigo: 'MAC',  nombre: 'Machen',            pais: 'Peru',    activo: true },
      { codigo: 'BOH',  nombre: 'Bohler',            pais: 'Austria', activo: true },
      { codigo: 'VIS',  nombre: 'Vistony',           pais: 'Peru',    activo: true },
      { codigo: 'CAN',  nombre: 'Cantesco',          pais: 'USA',     activo: true },
      { codigo: 'TEK',  nombre: 'Tekbond',           pais: 'Brazil',  activo: true },
      { codigo: 'SOL',  nombre: 'Solpack',           pais: 'Peru',    activo: true },
      { codigo: 'TRU',  nombre: 'Truper',            pais: 'Mexico',  activo: true },
      { codigo: 'SHU',  nombre: 'Shurtape',          pais: 'USA',     activo: true },
      { codigo: 'C&A',  nombre: 'C&A',               pais: 'Peru',    activo: true },
      { codigo: 'NOR',  nombre: 'Norton',            pais: 'USA',     activo: true },
      { codigo: 'UYU',  nombre: 'Uyustools',         pais: 'Peru',    activo: true },
      { codigo: 'SIL',  nombre: 'Siliconi',          pais: 'Peru',    activo: true },
      { codigo: 'ANY',  nombre: 'Anypsa',            pais: 'Peru',    activo: true },
      { codigo: 'CLU',  nombre: 'Clute',             pais: 'Peru',    activo: true },
      { codigo: 'FER',  nombre: 'Ferrawyy',          pais: 'Peru',    activo: true },
      { codigo: 'PRO',  nombre: 'Protec',            pais: 'Peru',    activo: true },
      { codigo: 'BAH',  nombre: 'Bahco',             pais: 'Sweden',  activo: true },
      { codigo: 'ABR',  nombre: 'Abralit',           pais: 'Peru',    activo: true },
      { codigo: 'SEG',  nombre: 'Segpro',            pais: 'Peru',    activo: true },
      { codigo: 'HEN',  nombre: 'Henkel',            pais: 'Germany', activo: true },
      { codigo: 'KLI',  nombre: 'Klingspor',         pais: 'Germany', activo: true },
      { codigo: 'STE',  nombre: 'Steelpro',          pais: 'Peru',    activo: true },
      { codigo: 'ELI',  nombre: 'Elite',             pais: 'Peru',    activo: true },
      { codigo: 'SDM',  nombre: 'Soldimix',          pais: 'Peru',    activo: true },
      { codigo: 'ESA',  nombre: 'ESAB',              pais: 'Sweden',  activo: true },
      { codigo: 'OER',  nombre: 'Oerlikon',          pais: 'Switzerland', activo: true },
      { codigo: 'NAC',  nombre: 'Nacho',             pais: 'Peru',    activo: true },
      { codigo: 'TRA',  nombre: 'Trapex',            pais: 'Peru',    activo: true },
      { codigo: 'ALI',  nombre: 'Alicorp',           pais: 'Peru',    activo: true },
      { codigo: '3M',   nombre: '3M',                pais: 'USA',     activo: true },
      { codigo: 'ANS',  nombre: 'Ansell',            pais: 'Australia', activo: true },
      { codigo: 'XIA',  nombre: 'Xiadal',            pais: 'Peru',    activo: true },
      { codigo: 'ARA',  nombre: 'Aragcu',            pais: 'Peru',    activo: true },
      { codigo: 'LIN',  nombre: 'Linde / Lincoln',   pais: 'Germany', activo: true },
      { codigo: 'ALD',  nombre: 'Aldise',            pais: 'Peru',    activo: true },
      { codigo: 'SUN',  nombre: 'Sunnen',            pais: 'USA',     activo: true },
      { codigo: 'ZCC',  nombre: 'ZCC-CT',            pais: 'China',   activo: true },
      // ── Equipos maquinado HP&K ──
      { codigo: 'COL',  nombre: 'Columbia',          pais: 'USA',     activo: true },
      { codigo: 'SAR',  nombre: 'Saro',              pais: 'China',   activo: true },
      { codigo: 'NIL',  nombre: 'Niles',             pais: 'Germany', activo: true },
      { codigo: 'ZAY',  nombre: 'Zayer',             pais: 'Spain',   activo: true },
      { codigo: 'UNI',  nombre: 'Union',             pais: 'Germany', activo: true },
      { codigo: 'SIR',  nombre: 'Sir-Mec',           pais: 'Italy',   activo: true },
      { codigo: 'MIL',  nombre: 'Miller Electric',   pais: 'USA',     activo: true },
      // ── Hidráulicos / sellos ──
      { codigo: 'PAR',  nombre: 'Parker Hannifin',   pais: 'USA',     activo: true },
      { codigo: 'IKO',  nombre: 'IKO',               pais: 'Japan',   activo: true },
      // ── Herramientas ──
      { codigo: 'BOC',  nombre: 'Bosch',             pais: 'Germany', activo: true },
      { codigo: 'MAK',  nombre: 'Makita',            pais: 'Japan',   activo: true },
      { codigo: 'MET',  nombre: 'Metabo',            pais: 'Germany', activo: true },
      { codigo: 'SNP',  nombre: 'Snap-on',           pais: 'USA',     activo: true },
      // ── Vehículos ──
      { codigo: 'HAN',  nombre: 'Hangcha',           pais: 'China',   activo: true },
      { codigo: 'JAC',  nombre: 'JAC Motors',        pais: 'China',   activo: true },
      { codigo: 'TOY',  nombre: 'Toyota',            pais: 'Japan',   activo: true },
      { codigo: 'VW',   nombre: 'Volkswagen',        pais: 'Germany', activo: true },
      { codigo: 'HYU',  nombre: 'Hyundai',           pais: 'Korea',   activo: true },
    ], { updateOnDuplicate: ['nombre', 'pais', 'activo'] });
    console.log('✓ 57 fabricantes\n');
    ...
    await Clasificacion.bulkCreate([
      // Catálogo completo de 82 clasificaciones (desde Excel 1 Log - material)
      { codigo: 'ACEI',  nombre: 'Aceite',                 activo: true },
      { codigo: 'ACER',  nombre: 'Acero',                  activo: true },
      { codigo: 'ADAP',  nombre: 'Adaptador',              activo: true },
      { codigo: 'ANIL',  nombre: 'Anillo',                 activo: true },
      { codigo: 'ADES',  nombre: 'Anillo de desgaste',     activo: true },
      { codigo: 'AMET',  nombre: 'Anillo metálico',        activo: true },
      { codigo: 'ARES',  nombre: 'Anillo de respaldo',     activo: true },
      { codigo: 'ARET',  nombre: 'Anillo de retención',    activo: true },
      { codigo: 'ARAN',  nombre: 'Arandela',               activo: true },
      { codigo: 'AGOM',  nombre: 'Arandela de goma',       activo: true },
      { codigo: 'BACK',  nombre: 'Back Up',                activo: true },
      { codigo: 'BARR',  nombre: 'Barras',                 activo: true },
      { codigo: 'BILL',  nombre: 'Billa',                  activo: true },
      { codigo: 'BLAD',  nombre: 'Bladder',                activo: true },
      { codigo: 'BUFF',  nombre: 'Buffer',                 activo: true },
      { codigo: 'CALC',  nombre: 'Calce',                  activo: true },
      { codigo: 'CASE',  nombre: 'Carrier Seal',           activo: true },
      { codigo: 'CASQ',  nombre: 'Casquillo',              activo: true },
      { codigo: 'COJI',  nombre: 'Cojinete',               activo: true },
      { codigo: 'CAMO',  nombre: 'Conjunto amortiguador',  activo: true },
      { codigo: 'CENC',  nombre: 'Conjunto de enchufe',    activo: true },
      { codigo: 'CIMA',  nombre: 'Conjunto de imán',       activo: true },
      { codigo: 'CRES',  nombre: 'Conjunto de resorte',    activo: true },
      { codigo: 'CSEL',  nombre: 'Conjunto de sello',      activo: true },
      { codigo: 'CTAP',  nombre: 'Conjunto de tapón',      activo: true },
      { codigo: 'CVAL',  nombre: 'Conjunto de válvula',    activo: true },
      { codigo: 'CONR',  nombre: 'Cone Roller',            activo: true },
      { codigo: 'CONT',  nombre: 'Contratuerca',           activo: true },
      { codigo: 'CUPR',  nombre: 'Cup Roller',             activo: true },
      { codigo: 'DAMP',  nombre: 'Damper',                 activo: true },
      { codigo: 'DISC',  nombre: 'Discos',                 activo: true },
      { codigo: 'DFRI',  nombre: 'Disco de fricción',      activo: true },
      { codigo: 'DOWS',  nombre: 'Dowel Spring',           activo: true },
      { codigo: 'DUOC',  nombre: 'Duo Cone',               activo: true },
      { codigo: 'EMB',   nombre: 'Émbolo',                 activo: true },
      { codigo: 'EPPS',  nombre: 'Equipo de seguridad',    activo: true },
      { codigo: 'ESPA',  nombre: 'Espaciador',             activo: true },
      { codigo: 'ESPI',  nombre: 'Espiga',                 activo: true },
      { codigo: 'GUIA',  nombre: 'Guía',                   activo: true },
      { codigo: 'IMAN',  nombre: 'Imán',                   activo: true },
      { codigo: 'INSE',  nombre: 'Insert',                 activo: true },
      { codigo: 'IRONC', nombre: 'Iron Cast',              activo: true },
      { codigo: 'JUREC', nombre: 'Juego de receptáculo',   activo: true },
      { codigo: 'KITB',  nombre: 'Kit de bladder',         activo: true },
      { codigo: 'KITS',  nombre: 'Kit de sellos',          activo: true },
      { codigo: 'LIMP',  nombre: 'Limpiadores',            activo: true },
      { codigo: 'MANG',  nombre: 'Manguito',               activo: true },
      { codigo: 'ORIN',  nombre: 'Sello anular / O-Ring',  activo: true },
      { codigo: 'PASA',  nombre: 'Pasador',                activo: true },
      { codigo: 'PERN',  nombre: 'Perno',                  activo: true },
      { codigo: 'PISTA', nombre: 'Pista',                  activo: true },
      { codigo: 'PLCA',  nombre: 'Placa',                  activo: true },
      { codigo: 'PLTE',  nombre: 'Plate',                  activo: true },
      { codigo: 'PLUG',  nombre: 'Plug',                   activo: true },
      { codigo: 'PRIB',  nombre: 'Prisionero de bola',     activo: true },
      { codigo: 'PRIS',  nombre: 'Prisionero',             activo: true },
      { codigo: 'PROT',  nombre: 'Protector',              activo: true },
      { codigo: 'PROV',  nombre: 'Protector de válvula',   activo: true },
      { codigo: 'RESO',  nombre: 'Resorte',                activo: true },
      { codigo: 'RETE',  nombre: 'Retén',                  activo: true },
      { codigo: 'RINC',  nombre: 'Ring Cushion',           activo: true },
      { codigo: 'RODA',  nombre: 'Rodamiento',             activo: true },
      { codigo: 'RODB',  nombre: 'Rod Bushing',            activo: true },
      { codigo: 'ROTU',  nombre: 'Rótulas',                activo: true },
      { codigo: 'SEGS',  nombre: 'Seguro seager',          activo: true },
      { codigo: 'SEGU',  nombre: 'Seguros',                activo: true },
      { codigo: 'SELA',  nombre: 'Sello anillo',           activo: true },
      { codigo: 'SELC',  nombre: 'Sello de culata',        activo: true },
      { codigo: 'SELF',  nombre: 'Sello de funda',         activo: true },
      { codigo: 'SELL',  nombre: 'Sellos',                 activo: true },
      { codigo: 'SELP',  nombre: 'Sello principal',        activo: true },
      { codigo: 'SENS',  nombre: 'Sensores',               activo: true },
      { codigo: 'SENSV', nombre: 'Sensor de velocidad',    activo: true },
      { codigo: 'SHIM',  nombre: 'Shim',                   activo: true },
      { codigo: 'SUMI',  nombre: 'Suministros',            activo: true },
      { codigo: 'TAPA',  nombre: 'Tapa',                   activo: true },
      { codigo: 'TAPO',  nombre: 'Tapón',                  activo: true },
      { codigo: 'TORN',  nombre: 'Tornillo',               activo: true },
      { codigo: 'TRAB',  nombre: 'Trabador',               activo: true },
      { codigo: 'TUBO',  nombre: 'Tubos',                  activo: true },
      { codigo: 'TUER',  nombre: 'Tuerca',                 activo: true },
      { codigo: 'UNIF',  nombre: 'Uniformes',              activo: true },
      { codigo: 'VALV',  nombre: 'Válvula',                activo: true },
    ], { updateOnDuplicate: ['nombre', 'activo'] });
    console.log('✓ 83 clasificaciones\n');
